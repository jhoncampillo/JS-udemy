...
// selccionar la navegacion
const navegacion2 = document.querySelector('.navegacion');
console.log(navegacion2.children); // miro la posicion
navegacion2.insertBefore(enlace, navegacion2.children[2]);
...
parrafo1.textContent = 'Conciertooooooooooooooooo';
parrafo1.classList.add('categoria');
parrafo1.classList.add('concierto');

// Segundo parrafo
const parrafo2 = document.createElement('P');
parrafo2.textContent = 'Concierto de Rockkkkkkkkkkkkkkk';
parrafo2.classList.add('titulo');

// 3er parrafo...
const parrafo3 = document.createElement('p');
parrafo3.textContent = '$8000000000000000000000 por pesrona';
