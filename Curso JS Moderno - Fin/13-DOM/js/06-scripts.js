...
console.log(encabezado.innerText); // se trae el texto. si en ccs esta visibility:hidden este no lo
console.log(encabezado.textContent); // se trae el texto
console.log(encabezado.innerHTML); // se trae le HTML
...
const textoEncabezado = document.querySelector('.contenido-hero h1')
  .textContent;
...
const nuevoTexto = 'Nuevo Heading de Busqueda';
